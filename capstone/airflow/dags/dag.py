...
from scripts.modeling_airflow2 import *
...
t14 = PythonOperator(
    task_id = 'train_validate_and_test'
...
#     ,op_kwargs={'input_df':'/usr/local/tmp_data/test.csv','target':'song popularity','validation_flag':'False'}
#     ,provide_context = True
#     ,dag=dag
# )
